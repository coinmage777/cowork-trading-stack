...
BBO polling hot path의 Rust 후보 구현. **2026-04-25 분석 결과 `ROI 낮음`**으로 판정되어 production 연동은 보류. 스캐폴드/벤치/테스트만 존재.
...
```bash
cd rust-services
export CARGO_TARGET_DIR=/c/Users/A/AppData/Local/Temp/dh-bbo-target  # Windows Google Drive lock 회피
