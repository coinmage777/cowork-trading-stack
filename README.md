...
| [`predict-fun-sniper/`](./predict-fun-sniper/) | [Predict.fun](https://predict.fun?ref=5302B) (BSC) 1-hour market mid-time sniper + JWT auth + BNB gas monitor. <br>[Predict.fun](https://predict.fun?ref=5302B) 1시간 마켓 mid-time 스나이퍼 |
